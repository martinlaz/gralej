...
class OM {
    static class Flags {
        ...
        boolean isHidden()    { return (flags & HIDDEN) != 0; }
        boolean isDifferent() { return (flags & DIFFERENT) != 0; }
        boolean isStruckout() { return (flags & STRUCKOUT) != 0; }
        boolean isMultiline() { return (flags & MULTILINE) != 0; }
        boolean isExpanded()  { return (flags & EXPANDED) != 0; }
        
        void setHidden()      { flags |= HIDDEN; }
        void setDifferent()   { flags |= DIFFERENT; }
        void setStruckout()   { flags |= STRUCKOUT; }
        void setMultiline()   { flags |= MULTILINE; }
        void setExpanded()    { flags |= EXPANDED; }
    }
    
    static class Entity implements IEntity {
        Flags _flags;
        
        Entity(Flags flags) { _flags = flags; }
        
        public boolean isHidden()  { return _flags.isHidden(); }
        public boolean isDifferent() { return _flags.isDifferent(); }
        public boolean isStruckout() { return _flags.isStruckout(); }
        public boolean isMultiline() { return _flags.isMultiline(); }
        public boolean isExpanded() { return _flags.isExpanded(); }
    ...
    static class FeatVal extends Entity implements IFeatureValuePair {
        ...
        public String feature() { return _f; }
        public IEntity value()  { return _v; }
    ...
    static class TFS extends Entity implements ITypedFeatureStructure {
        ...
        TFS(Flags flags, String typeName, java.util.List<IFeatureValuePair> featVals) {
            super(flags);
            _typeName = typeName;
            _featVals = featVals;
        }
    ...
    static class Tree implements ITree {
        ...
        Tree(String label, IEntity content, java.util.List<ITree> children) {
            _label = label;
            _content = content;
            _children = children;
        }
