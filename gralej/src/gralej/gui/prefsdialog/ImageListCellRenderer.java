...
/**
 * A cell renderer that allows {@link javax.swing.JList} to dislay icons. This
 * is mostly a copy from
 * {@link http://java.sun.com/docs/books/tutorial/uiswing/components/combobox.html#renderer}
 * 
 * @author no
 * @version $Id: ImageListCellRenderer.java 167 2007-12-07 15:10:06Z
 *          niels@drni.de $
 */
class ImageListCellRenderer extends JLabel implements ListCellRenderer {
    ...
    public ImageListCellRenderer(ImageIcon[] images, String[] labels) {
        ...
        setOpaque(true);
        setBorder(BorderFactory.createEmptyBorder(spacing, spacing, spacing,
                spacing));
