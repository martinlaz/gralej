...
final class Parsers {
    ...
    static LRTable loadLRTable(String grammarResourceName) {
        ...
        // we don't use precompiled grammars anymore -- it's
        // just not worth it, because the compilation of the grammars
        // is fast enough

//        is = _class.getResourceAsStream(grammarResourceName + ".bin");
//        if (is != null) {
//            try {
