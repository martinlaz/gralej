...
public class WebTraleClient extends JPanel {
    ...
    private InputStream getStream(String spec) throws IOException {
        HttpURLConnection con = (HttpURLConnection) new URL(webtraleContextURL, spec).openConnection();
        try {
    ...
    private void request(String prefix, String suffix) {
        try {
            InputStream is = getStream(prefix + URLEncoder.encode(suffix, "UTF-8"));
            if (is == null)
                return;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sentence", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(51, 51, 255)));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lexicon", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(51, 51, 255)));
