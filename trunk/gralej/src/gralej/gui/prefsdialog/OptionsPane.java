...
/**
 * basic internal functionality of a pane (or panel) holding a buch of options
 * (which should be {@link OptionComponent})
 * 
 * @author no
 * @version $Id$
 */
public abstract class OptionsPane extends JComponent {
    ...
    /**
     * reloads the preferences of all components of this OptionsPane that are
     * instances of {@link OptionComponent}
     * 
     */
    void reloadAllPrefs() {
    ...
    /**
     * saves the preferences of all components that are instances of
