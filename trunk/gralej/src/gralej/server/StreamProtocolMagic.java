...
/**
 * A class providing guessing methods to 
 * detect the protocol/format of a stream.
...
public class StreamProtocolMagic {
	...
	/**
	 * Detects the type if the stream and returns a
	 * string identifying it.
	 ...
	 * BufferedInputStream afterwards, otherwise the bytes read
	 * for the magic mechanism will be lost.
